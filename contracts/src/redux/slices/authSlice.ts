...
const authSlice = createSlice({
  ...
  initialState,
  reducers: {
    changeUser(state, action: PayloadAction<string | undefined>) {
...
export const { changeStatus, changeIsAuth, changeIsLoading, changeIsCheked, changeUser } = authSlice.actions;
