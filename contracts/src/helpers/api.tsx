...
export const fetchContractsByOrgIdMonth = (orgId: string, month: number): Promise<Contract> => {
...
export const updatePerson = (person: Personal): Promise<Personal | undefined | void> => {
...
export const removePerson = (id: { id: number }): Promise<{ isRemove: boolean }> => {
  return fetchData(`removePersonal`, 'DELETE', `Не удалось удалить сотрудника`, id);
};
...
export const fetchServicesByOrgIdMonth = (orgId: string, month: number): Promise<Service[]> => {
...
export const removeService = (id: { id: number }): Promise<{ isRemove: boolean }> => {
  return fetchData(`removeService`, 'DELETE', `Не удалось удалить услугу`, id);
};
