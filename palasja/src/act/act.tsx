    ...
    <>
      {info?.contract === null || head === undefined || sign === undefined ? (
        ...
        <>
          ...
          <div>
            <p>
              Мы, нижеподписавшиеся: {`${LAST_NAME} ${FIRST_NAME} ${MIDDLE_NAME}`}, с одной стороны
              и {`${sign?.lastName} ${sign?.firstName} ${sign?.middleName}`}, с другой стороны,
              составили настоящий акт в том, что первый выполнил работы в расчетно- справочном
              центре:
            </p>
          </div>
          <table>
